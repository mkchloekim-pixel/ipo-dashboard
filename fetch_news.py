...
COMPANIES = {
    ...
    'kurly': (
        ['컬리', '마켓컬리', '뷰티컬리'],
        ['참프레', '쿠팡', '이마트', '롯데', 'SSG', '오아시스', '코스트코', '홈플러스', '단발', '컬리단발', '컬리헤어']
    ),
    'ohouse': (
        ['오늘의집', '버킷플레이스'],
        []
    ...
    '2020': (
        ['이공이공', '이공이공 IPO', '이공이공 투자', 'egongegong'],
        ['이공계', '이공계열', '이공대', '공대']
    ),
    'lafati': (
        ['레페리'],
    ...
    'grainon': (
        ['그레인온', '카무트 효소', '그레인온 효소'],
        ['카무트 밀', '카무트 쌀', '카무트 재배', '카무트 원산지', '카무트 효능', '카무트 다이어트']
    ),
    'boosterz': (
        ['부스터즈', '부스터즈 상장', '부스터즈 우주텍', '르무통 IPO', '부스터즈 링티'],
        ['게임', '스타트업 부스터', '부스터샷', '창업 부스터', '부스터 프로그램']
    ),
}
...
RISK_EXCLUDE = [
    ...
    '적자 축소', '턴어라운드', '흑자로', '청신호', '끊었다',
    '선순환', '성장공', '흑자 기조', '수익성 개선', '마진 개선',
]
